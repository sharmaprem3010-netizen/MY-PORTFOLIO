...
import { Cpu, Code2, Globe, Terminal, Laptop, Search, CheckCircle, Sparkles } from 'lucide-react';
          ...
          >
            {filteredSkills.map((skill) => (
              <motion.div
                ...
                className="bg-[#0D121F] rounded-xl p-5 border border-slate-800/90 hover:border-slate-700 hover:bg-[#101728] transition-all duration-200 shadow-lg flex flex-col justify-between group"
              >
                <div>
