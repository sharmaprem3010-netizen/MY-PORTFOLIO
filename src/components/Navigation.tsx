...
export default function Navigation({ progress, onNavigate, onOpenRecruiter }: NavigationProps) {
  ...
  // Lock body scroll when mobile menu is open to prevent page sway / bounce
  useEffect(() => {
    if (mobileOpen) {
          ...
          >
            ...
            <div className="mobile-menu-links">
              ...
              <a
                ...
                data-testid="mobile-nav-resume-link"
              >
                <span className="mobile-link-num">PDF</span>
                <span className="mobile-link-label">DOWNLOAD ATS RESUME</span>
                <span className="mobile-link-arrow">↓</span>
              </a>
            </div>
            ...
            <div className="mobile-menu-footer">
              ...
              <div className="mobile-menu-socials">
                ...
                <a href="https://www.linkedin.com/in/premsharmatech" target="_blank" rel="noreferrer">LINKEDIN ↗</a>
              </div>
            </div>
          </div>
        </div>
